...
"}")
        ...
        self.scrollArea.setGeometry(QtCore.QRect(900, 70, 251, 371))
        self.scrollArea.setAutoFillBackground(False)
        self.scrollArea.setStyleSheet("background-color: lightgrey;")
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 251, 371))
        ...
        self.isOnline.setGeometry(QtCore.QRect(900, 510, 111, 31))
        self.isOnline.setStyleSheet("color:white")
        self.isOnline.setChecked(True)
        self.isOnline.setObjectName("isOnline")
        self.isOffline = QtWidgets.QRadioButton(self.frame)
        self.isOffline.setGeometry(QtCore.QRect(900, 540, 151, 31))
        self.isOffline.setStyleSheet("color:white")
        self.isOffline.setObjectName("isOffline")
        self.uploadButton = QtWidgets.QPushButton(self.frame)
        self.uploadButton.setGeometry(QtCore.QRect(680, 520, 191, 51))
        self.uploadButton.setObjectName("uploadButton")
        self.downloadButton = QtWidgets.QPushButton(self.frame)
        self.downloadButton.setGeometry(QtCore.QRect(680, 460, 191, 51))
        ...
        self.sendButton.setGeometry(QtCore.QRect(580, 460, 91, 111))
        self.sendButton.setStyleSheet("")
        self.sendButton.setText("")
        self.sendButton.setObjectName("sendButton")
        self.exitAccountButton = QtWidgets.QToolButton(self.frame)
        self.exitAccountButton.setGeometry(QtCore.QRect(1100, 460, 51, 51))
        self.exitAccountButton.setStyleSheet("border-radius: 15px")
        self.exitAccountButton.setText("")
        self.exitAccountButton.setObjectName("exitAccountButton")
        self.disconnectButton = QtWidgets.QToolButton(self.frame)
        self.disconnectButton.setGeometry(QtCore.QRect(1100, 520, 51, 51))
        self.disconnectButton.setStyleSheet("border-radius: 15px;")
        self.disconnectButton.setText("")
        self.disconnectButton.setObjectName("disconnectButton")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(900, 450, 161, 61))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Сортировка пользователей:"))
